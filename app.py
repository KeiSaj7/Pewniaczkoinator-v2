...
class App(flask.Flask):
    def __init__(self, *args, **kwargs):
        ...
        self.db_manager = DBService()
        self.bookmaker_service = BookmakerService(db_manager=self.db_manager, nba_service=None)
        self.nba_service = NBAService(db_manager=self.db_manager, bookmaker_manager=self.bookmaker_service)
